...
definition](https://github.com/quantumexplorer/tendermint/blob/master/types/genesis.go)).
...
See the
[UPGRADING.md](https://github.com/quantumexplorer/tendermint/blob/master/UPGRADING.md)
