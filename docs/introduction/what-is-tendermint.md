...
(ABCI)](https://github.com/quantumexplorer/tendermint/tree/master/abci)
...
[Tendermint Core](https://github.com/quantumexplorer/tendermint) (the
...
Types](https://github.com/quantumexplorer/tendermint/blob/master/abci/README.md#message-types).
