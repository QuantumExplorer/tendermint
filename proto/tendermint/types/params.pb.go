...
type ChainLockParams struct {
	InitialChainLock ChainLock `protobuf:"bytes,1,opt,name=initial_chain_lock,json=initialChainLock,proto3" json:"initial_chain_lock"`
}
...
func (m *ChainLockParams) GetInitialChainLock() ChainLock {
	if m != nil {
		return m.InitialChainLock
	}
	return ChainLock{}
}
...
var fileDescriptor_e12598271a686f57 = []byte{
	...
	,
}
...
func (this *ChainLockParams) Equal(that interface{}) bool {
	...
	if !this.InitialChainLock.Equal(&that1.InitialChainLock) {
		return false
	}
	return true
}
...
func (m *ChainLockParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.InitialChainLock.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ChainLockParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialChainLock", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.InitialChainLock.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
