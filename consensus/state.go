...
import (
	...
	"github.com/quantumexplorer/tendermint/libs/fail"
...
func (cs *State) defaultDecideProposal(height int64, round int32) {
	...
	proposal := types.NewProposal(height, cs.state.ConsensusParams.ChainLock.NewestChainLock.ChainLockHeight, round, cs.ValidRound, propBlockID)
	p := proposal.ToProto()
